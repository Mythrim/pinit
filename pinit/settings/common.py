...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '1=odd^oma=lwdzx0up02#a_#2=0am42f4u=uq5nqrjrk21o7*&')
...
#             'when': 'midnight',
#             'backupCount': 10,
#             'filename': os.path.join(LOG_DIR, 'pinit.log'),
#             'formatter': 'verbose',
#         },
#         'console': {
#             'level': 'DEBUG',
